...
3. `Docs/Art/Wrath and Ruin - Art Production and Asset Planning Track.md`
4. `Docs/Art/Wrath and Ruin - Lead Artist Considerations.md`
5. `Docs/Art/Wrath and Ruin - Art Direction Asset List.md`

## What Is Strong Already

### `Lead Artist Considerations` is the stronger brief

`Docs/Art/Wrath and Ruin - Lead Artist Considerations.md` already does several important things correctly:
...
- `Docs/Art/Wrath and Ruin - Art Direction Asset List.md` is a useful backlog, but it is not safe as the main artist handoff.
...
Use `Docs/Art/Wrath and Ruin - Lead Artist Considerations.md` as the stronger assessor draft.

Use `Docs/Art/Wrath and Ruin - Art Direction Asset List.md` as a broad backlog reference only.
