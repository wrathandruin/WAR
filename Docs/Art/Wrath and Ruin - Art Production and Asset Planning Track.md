...
- `Docs/Art/Wrath and Ruin - Art Audit and Direction Lock.md`
- `Docs/Art/Wrath and Ruin - Lore and Visual Theme Guide.md`
- `Docs/Art/Wrath and Ruin - Lead Artist Onboarding Package.md`
- `Docs/Art/Wrath and Ruin - Art Asset Delivery Contract.md`
- `Docs/Art/Wrath and Ruin - Lead Artist Milestone Runway.md`
...
Use `Docs/Art/Wrath and Ruin - Art Asset Delivery Contract.md` for the exact file-level rules.
