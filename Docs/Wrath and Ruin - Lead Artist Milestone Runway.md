...
3. `Docs/Wrath and Ruin - Lore and Visual Theme Guide.md`
4. `Docs/Wrath and Ruin - Art Audit and Direction Lock.md`
5. `Docs/Wrath and Ruin - Art Production and Asset Planning Track.md`
6. `Docs/ChatGPT Lead Artist Prompt.md`
7. `Docs/Wrath and Ruin - M45-M70 Alpha Playtest Runway.md`
