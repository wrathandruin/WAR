...
- `Project/SourceManifests/BetaContent/`
- `Project/SourceManifests/Launcher/`
- `Project/SourceManifests/Installer/`
- `Project/SourceManifests/Onboarding/`
- `Project/SourceManifests/LiveOps/`
- `Project/SourceManifests/ReleaseManagement/`
- `Project/SourceManifests/Support/`
- `Project/SourceManifests/IncidentResponse/`
