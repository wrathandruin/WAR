...
namespace war
{
    ...
    LocalDemoDiagnosticsReport LocalDemoDiagnostics::buildReport(const RuntimeBoundaryReport& runtimeBoundaryReport)
    {
        ...
        const std::filesystem::path repoScripts = directoryExists(runtimeBoundaryReport.repoRoot / "Project" / "scripts")
            ? (runtimeBoundaryReport.repoRoot / "Project" / "scripts")
            : (runtimeBoundaryReport.repoRoot / "scripts");
        ...
        report.m45ValidationScriptPresent =
            ...
            || fileExists(executableDirectory / "validate_m54_session_mvp_win64.bat")
            || fileExists(executableDirectory / "validate_m55_session_mvp_win64.bat")
            || fileExists(executableDirectory / "validate_m56_session_mvp_win64.bat")
            || fileExists(executableDirectory / "validate_m57_session_mvp_win64.bat")
            || fileExists(executableDirectory / "validate_m58_session_mvp_win64.bat")
            || fileExists(executableDirectory / "validate_m59_session_mvp_win64.bat")
            || fileExists(executableDirectory / "validate_m59_session_mvp_package_win64.bat")
            ...
            || fileExists(executableDirectory / "scripts" / "validate_m54_session_mvp_win64.bat")
            || fileExists(executableDirectory / "scripts" / "validate_m55_session_mvp_win64.bat")
            || fileExists(executableDirectory / "scripts" / "validate_m56_session_mvp_win64.bat")
            || fileExists(executableDirectory / "scripts" / "validate_m57_session_mvp_win64.bat")
            || fileExists(executableDirectory / "scripts" / "validate_m58_session_mvp_win64.bat")
            || fileExists(executableDirectory / "scripts" / "validate_m59_session_mvp_win64.bat")
            || fileExists(executableDirectory / "scripts" / "validate_m59_session_mvp_package_win64.bat");
        ...
        report.repoPackagingScriptsReady = runtimeBoundaryReport.repoRootResolved
            && (
                ...
                || fileExists(repoScripts / "build_session_mvp_candidate_package_win64.bat")
            )
            ...
            && (
                ...
                || fileExists(repoScripts / "validate_m54_session_mvp_win64.bat")
            )
            && (
                fileExists(repoScripts / "validate_m45_internal_alpha_package_win64.bat")
                || fileExists(repoScripts / "validate_m59_session_mvp_package_win64.bat")
            );
        ...
        const IncidentResponseReport* incidentResponseReport)
    {
        ...
        output
            << "Trust boundary summary: Project/Environment is deployable config; Project/Runtime/Config is mutable runtime config; Project/Runtime/Saves, Project/Runtime/Logs, Project/Runtime/Host, and Project/Runtime/CrashDumps are runtime-owned.\n";
