    ...
    private:
        ...
        [[nodiscard]] static std::string buildChecklist()
        {
            ...
            output
                ...
                << "2. Confirm retention summary and launch journal are present under Project/Runtime/Logs/Retention.\n"
                << "3. Confirm release candidate manifest and checklist are present under Project/Runtime/Logs/ReleaseCandidate.\n"
