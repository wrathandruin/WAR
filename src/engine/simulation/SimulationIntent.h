...
namespace war
{
    enum class SimulationIntentType { MoveToTile, InspectTile, InteractTile };
    enum class SimulationIntentAckResult { None, Accepted, Rejected };

    struct SimulationIntent { uint64_t sequence = 0; SimulationIntentType type = SimulationIntentType::MoveToTile; TileCoord target{}; };
