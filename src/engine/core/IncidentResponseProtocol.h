    ...
    public:
        ...
        [[nodiscard]] static std::filesystem::path resolveIncidentManifestPath(const RuntimeBoundaryReport& runtimeBoundaryReport)
        {
            const std::filesystem::path packagedPath =
                runtimeBoundaryReport.executableDirectory / "IncidentResponse" / "m53_incident_response_manifest.txt";
            const std::filesystem::path sourcePath =
                runtimeBoundaryReport.repoRoot / "IncidentResponse" / "m53_incident_response_manifest.txt";
